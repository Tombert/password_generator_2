...
/* package conduit-combinators-1.0.8.3 */
#define VERSION_conduit_combinators "1.0.8.3"
...
#define CURRENT_COMPONENT_ID "test-0.1.0.0-2XRt171kZbvJmf0kRxHb6K"

#define CURRENT_PACKAGE_KEY "test-0.1.0.0-2XRt171kZbvJmf0kRxHb6K"
